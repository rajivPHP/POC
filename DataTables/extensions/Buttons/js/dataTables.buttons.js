...
$.extend( Buttons.prototype, {
	...
	/**
	 * Get the gridimages node for the buttons
...
// Get the gridimages elements for the button sets selected
DataTable.Api.registerPlural( 'buttons().containers()', 'buttons().gridimages()', function () {
	var jq = $();
