...
(function() {
  ...
  this.Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      container_classes = ["chosen-gridimages"];
      container_classes.push("chosen-gridimages-" + (this.is_multiple ? "multi" : "single"));
    ...
    Chosen.prototype.blur_test = function(evt) {
      if (!this.active_field && this.container.hasClassName("chosen-gridimages-active")) {
        return this.close_field();
      }
    };
    ...
    Chosen.prototype.close_field = function() {
      ...
      this.active_field = false;
      this.results_hide();
      this.container.removeClassName("chosen-gridimages-active");
    ...
    Chosen.prototype.activate_field = function() {
      this.container.addClassName("chosen-gridimages-active");
    ...
    Chosen.prototype.test_active_click = function(evt) {
      if (evt.target.up('.chosen-gridimages') === this.container) {
    ...
    Chosen.prototype.results_build = function() {
      ...
      if (this.is_multiple) {
        ...
        if (this.disable_search || this.form_field.options.length <= this.disable_search_threshold) {
          ...
          this.container.addClassName("chosen-gridimages-single-nosearch");
        } else {
          this.search_field.readOnly = false;
          this.container.removeClassName("chosen-gridimages-single-nosearch");
        }
      }
      this.update_results_content(this.results_option_build({
        first: true
