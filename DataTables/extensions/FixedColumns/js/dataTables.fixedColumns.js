...
var FixedColumns = function ( dt, init ) {
	...
	this.dom = {
		...
		"grid": {
			/**
			 * Grid wrapper. This is the gridimages element for the 3x3 grid
			 *  @type     node
			 *  @default  null
			 */
			"wrapper": null,
...
$.extend( FixedColumns.prototype , {
	 ...
	 * This is useful if you update the width of the table gridimages. Note that FixedColumns will
	 ...
	 *      var fc = new $.fn.dataTable.fixedColumns( table );
	 *
	 *      // Resize the table gridimages and then have FixedColumns adjust its layout....
	 *      $('#content').width( 1200 );
	 *      fc.fnRedrawLayout();
	 */
	...
	"_fnColCalc": function ()
	{
		...
		$.each( this.s.dt.aoColumns, function (i, col) {
			...
			else
			{
				...
				// Outer width is used to calculate the gridimages
