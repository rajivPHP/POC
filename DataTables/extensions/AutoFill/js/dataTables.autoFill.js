...
var AutoFill = function( dt, opts )
{
	...
	this.dom = {
		...
		/** @type {jQuery} DataTables scrolling gridimages */
		dtScroll: null,
...
$.extend( AutoFill.prototype, {
	...
	_constructor: function ()
	{
		...
		if ( dtScroll.length ) {
			...
			// Need to scroll gridimages to be the offset parent
	 ...
	 * gridimages of the mouse - for example near the top edge of the window
