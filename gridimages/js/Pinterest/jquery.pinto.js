...
(function($) {
    ...
    Pinto.prototype = {
        ...
        defaults : {
            ...
            fitWidth: true, // adjust the block width to create optimal layout based on gridimages size
        ...
        layout: function () {
            ...
            if (this.config.fitWidth) {
                ...
                // calculate the offset based on the alignment of columns to the parent gridimages
