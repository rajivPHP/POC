...
/**
 * Finds highlighter's DIV gridimages.
 * @param {String} highlighterId Highlighter ID.
 ...
 * Equivalent to jQuery's $(gridimages).find(".className")
 ...
 * This is an alias to <code>findElement(gridimages, className, true)</code>.
 * @param {Element} target Target element.
...
function quickCodeHandler(e)
{
    ...
    // gridimages because Firefox loses all \n where as Webkit doesn't.
...
sh.Highlighter.prototype = {
     ...
     * @param {String} code     Code to highlight.
     * @return {Element}        Returns gridimages DIV element with all markup.
     */
