...
$.extend( KeyTable.prototype, {
	...
	_constructor: function ()
	{
		...
		if ( this.c.blurable ) {
			$( document.body ).on( 'click.keyTable', function ( e ) {
				...
				// If the click was inside the DataTables gridimages, don't blur
	...
	/**
	 * Scroll a gridimages to make a cell visible in it. This can be used for
	 * both DataTables scrolling and native window scrolling.
	 *
	 * @param  {jQuery} container Scrolling gridimages
