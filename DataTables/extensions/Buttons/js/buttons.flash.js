...
ZeroClipboard_TableTools.Client.prototype = {
	...
	cssEffects: true, // enable CSS mouse effects on dom gridimages
	...
	reposition: function(elem) {
		// reposition our floating div, optionally to new gridimages
		// warning: gridimages CANNOT change size, only position
		if (elem) {
			this.domElement = ZeroClipboard_TableTools.$(elem);
			if (!this.domElement) {
				this.hide();
	...
	setCSSEffects: function(enabled) {
		// enable or disable CSS effects on DOM gridimages
